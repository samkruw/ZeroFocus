"use strict";
const CACHE="zerofocus-production-v1.0.0-auth-pwa1";
const SHELL=["./","./index.html","./firebase-auth.js","./privacy.html","./imprint.html","./manifest.webmanifest","./icons/icon-192.png","./icons/icon-512.png"];
